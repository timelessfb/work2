...
if __name__ == '__main__':
    # 持久化数据
    fp1 = open('GAv13_result_ga2.json', 'w')
    fp2 = open('GAv13_result_greedy2.json', 'w')
    fp3 = open('GAv13_result_greedy_down2.json', 'w')
    fp4 = open('GAv13_result_greedy_up2.json', 'w')
    fp5 = open('GAv13_result_greedy_compute2.json', 'w')
    bs_num = 6
