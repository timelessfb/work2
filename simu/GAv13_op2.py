...
if __name__ == '__main__':
    # 持久化数据
    fp1 = open('GAv13_op2_result_ga.json', 'w')
    fp2 = open('GAv13_op2_result_greedy.json', 'w')
    fp3 = open('GAv13_op2_result_greedy_down.json', 'w')
    fp4 = open('GAv13_op2_result_greedy_up.json', 'w')
    fp5 = open('GAv13_op2_result_greedy_compute.json', 'w')
    fp6 = open('GAv13_op2_result_greedy_resource.json', 'w')
    bs_num = 6
