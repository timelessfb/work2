...
# 方法1
def alg_optimize(S, J_num, X_map, load, RHO, I, ys, iter, K, mu, migration_degradation):
    o = np.zeros((iter, 5))
...
if __name__ == '__main__':
    ...
    # 参数10：生成切片调整因子K，RHO=K[i]*RHO
    K = generate_K(S, iter)
    print(K)

    mu = 0.5
    print("方法1:凸优化")
    o1 = alg_optimize(S, J_num, X_map, load, RHO, I, ys, iter, K, mu, migration_degradation)
    print(o1)
    print("方法2：静态")
